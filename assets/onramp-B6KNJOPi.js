import{i as T,a as f,x as c,H as X,I as l,J as N,K as x,A as E,O as S,M as I,e as O,u as J,f as q,h as F,W as H,R as j,d as M,b as z,B as G,l as Z,S as W,T as ee}from"./index-D0Nsga9L.js";import{n as d,c as g,o as h,r as u}from"./if-defined-8U-vdW-A.js";import{D as te,T as ie}from"./index-D6x7trua.js";import"./index-CfCzRn12.js";import"./index-D0CyGr97.js";import"./index-CtTbUAgI.js";import"./index-B245ew4x.js";import{O as L}from"./index-NRyrmRnW.js";import"./index-ZD5FZJcy.js";import"./index-BK0Pr3uV.js";import"./index-BgGfObRE.js";import"./index-Bsl9TG2a.js";import"./index-JthP3241.js";import"./index-C2Vyi6cn.js";import"./index-DIYLhsVa.js";import"./ref-CsYnbbf5.js";import"./ConstantsUtil-Dmg8YACJ.js";const re=T`
  :host {
    width: 100%;
  }
...
`;var B=function(n,e,i,r){var o=arguments.length,t=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,i,r);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,i,t):s(e,i))||t);return o>3&&t&&Object.defineProperty(e,i,t),t};const se=7;let k=class extends f{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=l.state.selectedProvider,this.loading=!1,this.coinbaseTransactions=N.state.coinbaseTransactions,this.tokenImages=x.state.tokenImages,this.unsubscribe.push(l.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}),x.subscribeKey("tokenImages",e=>this.tokenImages=e),()=>{clearTimeout(this.refetchTimeout)},N.subscribe(e=>{this.coinbaseTransactions={...e.coinbaseTransactions}})),N.clearCursor(),this.fetchTransactions()}render(){return c`
...
`;var D=function(n,e,i,r){var o=arguments.length,t=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,i,r);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,i,t):s(e,i))||t);return o>3&&t&&Object.defineProperty(e,i,t),t};let P=class extends f{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=l.state.paymentCurrency,this.currencies=l.state.paymentCurrencies,this.currencyImages=x.state.currencyImages,this.checked=L.state.isLegalCheckboxChecked,this.unsubscribe.push(l.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),x.subscribeKey("currencyImages",e=>this.currencyImages=e),L.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:i}=S.state,r=S.state.features?.legalCheckbox,s=!!(e||i)&&!!r&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(i=>c`
      ...
      `)}selectCurrency(e){e&&(l.setPaymentCurrency(e),I.close())}};P.styles=ne;D([u()],P.prototype,"selectedCurrency",void 0);D([u()],P.prototype,"currencies",void 0);D([u()],P.prototype,"currencyImages",void 0);D([u()],P.prototype,"checked",void 0);P=D([g("w3m-onramp-fiat-select-view")],P);const ae=T`
  button {
    padding: var(--wui-spacing-s);
    border-radius: var(--wui-border-radius-xs);
    border: none;
...
`;var R=function(n,e,i,r){var o=arguments.length,t=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,i,r);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,i,t):s(e,i))||t);return o>3&&t&&Object.defineProperty(e,i,t),t};let y=class extends f{constructor(){super(...arguments),this.disabled=!1,this.color="inherit",this.label="",this.feeRange="",this.loading=!1,this.onClick=null}render(){return c`
    ...
    `}networksTemplate(){const i=O.getAllRequestedCaipNetworks()?.filter(r=>r?.assets?.imageId)?.slice(0,5);return c`
...
`;var le=function(n,e,i,r){var o=arguments.length,t=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,i,r);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,i,t):s(e,i))||t);return o>3&&t&&Object.defineProperty(e,i,t),t};let K=class extends f{render(){const{termsConditionsUrl:e,privacyPolicyUrl:i}=S.state;return!e&&!i?null:c`
      <wui-flex
        .padding=${["m","s","s","s"]}
        flexDirection="column"
        alignItems="center"
    ...
    `}howDoesItWorkTemplate(){return c` <wui-link @click=${this.onWhatIsBuy.bind(this)}>
      ...
      How does it work?
    </wui-link>`}onWhatIsBuy(){const e=O.state.activeChain;q.sendEvent({type:"track",event:"SELECT_WHAT_IS_A_BUY",properties:{isSmartAccount:F(e)===H.ACCOUNT_TYPES.SMART_ACCOUNT}}),j.push("WhatIsABuy")}};K.styles=[ce];K=le([g("w3m-onramp-providers-footer")],K);var Q=function(n,e,i,r){var o=arguments.length,t=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,i,r);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,i,t):s(e,i))||t);return o>3&&t&&Object.defineProperty(e,i,t),t};let V=class extends f{constructor(){super(),this.unsubscribe=[],this.providers=l.state.providers,this.unsubscribe.push(l.subscribeKey("providers",e=>{this.providers=e}))}firstUpdated(){const e=this.providers.map(async i=>i.name==="coinbase"?await this.getCoinbaseOnRampURL():Promise.resolve(i?.url));Promise.all(e).then(i=>{this.providers=this.providers.map((r,o)=>({...r,url:i[o]||""}))})}render(){return c`
      <wui-flex flexDirection="column" .padding=${["0","s","s","s"]} gap="xs">
    ...
    `}onRampProvidersTemplate(){return this.providers.filter(e=>e.supportedChains.includes(O.state.activeChain??"eip155")).map(e=>c`
          ...
          ></w3m-onramp-provider-item>
        `)}onClickProvider(e){const i=O.state.activeChain;l.setSelectedProvider(e),j.push("BuyInProgress"),M.openHref(e.url,"popupWindow","width=600,height=800,scrollbars=yes"),q.sendEvent({type:"track",event:"SELECT_BUY_PROVIDER",properties:{provider:e.name,isSmartAccount:F(i)===H.ACCOUNT_TYPES.SMART_ACCOUNT}})}async getCoinbaseOnRampURL(){const e=E.state.address,i=O.state.activeCaipNetwork;if(!e)throw new Error("No address found");if(!i?.name)throw new Error("No network found");const r=z.WC_COINBASE_PAY_SDK_CHAIN_NAME_MAP[i.name]??z.WC_COINBASE_PAY_SDK_FALLBACK_CHAIN,o=l.state.purchaseCurrency,t=o?[o.symbol]:l.state.purchaseCurrencies.map(s=>s.symbol);return await G.generateOnRampURL({defaultNetwork:r,destinationWallets:[{address:e,blockchains:z.WC_COINBASE_PAY_SDK_CHAINS,assets:t}],partnerUserId:e,purchaseAmount:l.state.purchaseAmount})}};Q([u()],V.prototype,"providers",void 0);V=Q([g("w3m-onramp-providers-view")],V);const ue=T`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var U=function(n,e,i,r){var o=arguments.length,t=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,i,r);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,i,t):s(e,i))||t);return o>3&&t&&Object.defineProperty(e,i,t),t};let A=class extends f{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=l.state.purchaseCurrencies,this.tokens=l.state.purchaseCurrencies,this.tokenImages=x.state.tokenImages,this.checked=L.state.isLegalCheckboxChecked,this.unsubscribe.push(l.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),x.subscribeKey("tokenImages",e=>this.tokenImages=e),L.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:i}=S.state,r=S.state.features?.legalCheckbox,s=!!(e||i)&&!!r&&!this.checked;return c`
      <w3m-legal-checkbox></w3m-legal-checkbox>
      <wui-flex
        flexDirection="column"
        .padding=${["0","s","s","s"]}
    ...
    `}currenciesTemplate(e=!1){return this.tokens.map(i=>c`
      ...
      `)}selectToken(e){e&&(l.setPurchaseCurrency(e),I.close())}};A.styles=ue;U([u()],A.prototype,"selectedCurrency",void 0);U([u()],A.prototype,"tokens",void 0);U([u()],A.prototype,"tokenImages",void 0);U([u()],A.prototype,"checked",void 0);A=U([g("w3m-onramp-token-select-view")],A);const de=T`
  @keyframes shake {
    0% {
...
`;var $=function(n,e,i,r){var o=arguments.length,t=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,i,r);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(t=(o<3?s(t):o>3?s(e,i,t):s(e,i))||t);return o>3&&t&&Object.defineProperty(e,i,t),t};const we={USD:"$",EUR:"€",GBP:"£"},fe=[100,250,500,1e3];let v=class extends f{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=O.state.activeCaipAddress,this.loading=I.state.loading,this.paymentCurrency=l.state.paymentCurrency,this.paymentAmount=l.state.paymentAmount,this.purchaseAmount=l.state.purchaseAmount,this.quoteLoading=l.state.quotesLoading,this.unsubscribe.push(O.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),I.subscribeKey("loading",e=>{this.loading=e}),l.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return c`
    ...
    `}templateButton(){return this.caipAddress?c`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||I.open({view:"OnRampProviders"})}openModal(){I.open({view:"Connect"})}async onPaymentAmountChange(e){l.setPaymentAmount(Number(e.detail)),await l.getQuote()}async selectPresetAmount(e){l.setPaymentAmount(e),await l.getQuote()}};v.styles=me;$([d({type:Boolean})],v.prototype,"disabled",void 0);$([u()],v.prototype,"caipAddress",void 0);$([u()],v.prototype,"loading",void 0);$([u()],v.prototype,"paymentCurrency",void 0);$([u()],v.prototype,"paymentAmount",void 0);$([u()],v.prototype,"purchaseAmount",void 0);$([u()],v.prototype,"quoteLoading",void 0);v=$([g("w3m-onramp-widget")],v);export{m as W3mBuyInProgressView,k as W3mOnRampActivityView,V as W3mOnRampProvidersView,P as W3mOnrampFiatSelectView,A as W3mOnrampTokensView,v as W3mOnrampWidget,Y as W3mWhatIsABuyView};
