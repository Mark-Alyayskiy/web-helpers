import{i as A,a as C,e as I,N as P,x as u,b as V,f as O,R as T,A as E,d as K,M,h as F,W as Q,r as q,j as H}from"./index-T9pzRdMW.js";import{r as s,n as h,c as D,U as x}from"./if-defined-CDCoZrLG.js";import"./index-CeBmaj-U.js";import{M as N}from"./index-CcCLQcAv.js";import"./index-KdwhHYN1.js";import{S as i}from"./index-Du9kkbkF.js";import"./index-BAbFoc--.js";import"./index-CiOjCBno.js";import"./index-C-eHWr2d.js";import"./index-CtwxF4ci.js";import"./index-CLYCUXYZ.js";import"./index-CLf-6ja1.js";import"./ref-CZCCHWPa.js";const G={numericInputKeyDown(l,e,o){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=l.metaKey||l.ctrlKey,t=l.key,r=t.toLocaleLowerCase(),c=r==="a",U=r==="c",W=r==="v",z=r==="x",j=t===",",L=t===".",R=t>="0"&&t<="9";!a&&(c||U||W||z)&&l.preventDefault(),e==="0"&&!j&&!L&&t==="0"&&l.preventDefault(),e==="0"&&R&&(o(t),l.preventDefault()),(j||L)&&(e||(o("0."),l.preventDefault()),(e?.includes(".")||e?.includes(","))&&l.preventDefault()),!R&&!n.includes(t)&&!L&&!j&&l.preventDefault()}},Y=A`
  :host {
    width: 100%;
  }
