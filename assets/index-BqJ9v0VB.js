import{i as D,a as O,x as a,r as T,e as v,J as p,d as I,R as Y,O as L,f as z,h as E,W}from"./index-D0Nsga9L.js";import{n as l,c as R,o as S,r as x}from"./if-defined-8U-vdW-A.js";import{T as b,D as F}from"./index-D6x7trua.js";import"./index-CfCzRn12.js";import"./index-BK0Pr3uV.js";import"./index-D0CyGr97.js";var A;(function(r){r.approve="approved",r.bought="bought",r.borrow="borrowed",r.burn="burnt",r.cancel="canceled",r.claim="claimed",r.deploy="deployed",r.deposit="deposited",r.execute="executed",r.mint="minted",r.receive="received",r.repay="repaid",r.send="sent",r.sell="sold",r.stake="staked",r.trade="swapped",r.unstake="unstaked",r.withdraw="withdrawn"})(A||(A={}));const U=D`
  :host > wui-flex {
    display: flex;
...
`;var m=function(r,t,i,o){var s=arguments.length,e=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,i):o,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(r,t,i,o);else for(var c=r.length-1;c>=0;c--)(n=r[c])&&(e=(s<3?n(e):s>3?n(t,i,e):n(t,i))||e);return s>3&&e&&Object.defineProperty(t,i,e),e};let g=class extends O{constructor(){super(...arguments),this.images=[],this.secondImage={type:void 0,url:""}}render(){const[t,i]=this.images,o=t?.type==="NFT",s=i?.url?i.type==="NFT":o,e=o?"var(--wui-border-radius-xxs)":"var(--wui-border-radius-s)",n=s?"var(--wui-border-radius-xxs)":"var(--wui-border-radius-s)";return this.style.cssText=`
    ...
    `,a`<wui-flex> ${this.templateVisual()} ${this.templateIcon()} </wui-flex>`}templateVisual(){const[t,i]=this.images,o=t?.type;return this.images.length===2&&(t?.url||i?.url)?a`<div class="swap-images-container">
      ...
      ></wui-icon-box>
    `:null}getDirectionIcon(){switch(this.direction){case"in":return"arrowBottom";case"out":return"arrowTop";default:return}}getIcon(){return this.onlyDirectionIcon?this.getDirectionIcon():this.type==="trade"?"swapHorizontalBold":this.type==="approve"?"checkmark":this.type==="cancel"?"close":this.getDirectionIcon()}getStatusColor(){switch(this.status){case"confirmed":return"success-100";case"failed":return"error-100";case"pending":return"inverse-100";default:return"accent-100"}}};g.styles=[U];m([l()],g.prototype,"type",void 0);m([l()],g.prototype,"status",void 0);m([l()],g.prototype,"direction",void 0);m([l({type:Boolean})],g.prototype,"onlyDirectionIcon",void 0);m([l({type:Array})],g.prototype,"images",void 0);m([l({type:Object})],g.prototype,"secondImage",void 0);g=m([R("wui-transaction-visual")],g);const V=D`
...
`;var d=function(r,t,i,o){var s=arguments.length,e=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,i):o,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(r,t,i,o);else for(var c=r.length-1;c>=0;c--)(n=r[c])&&(e=(s<3?n(e):s>3?n(t,i,e):n(t,i))||e);return s>3&&e&&Object.defineProperty(t,i,e),e};let u=class extends O{constructor(){super(...arguments),this.type="approve",this.onlyDirectionIcon=!1,this.images=[],this.price=[],this.amount=[],this.symbol=[]}render(){return a`
    ...
    `}templateDescription(){const t=this.descriptions?.[0];return t?a`
        ...
        `:null}};u.styles=[T,V];d([l()],u.prototype,"type",void 0);d([l({type:Array})],u.prototype,"descriptions",void 0);d([l()],u.prototype,"date",void 0);d([l({type:Boolean})],u.prototype,"onlyDirectionIcon",void 0);d([l()],u.prototype,"status",void 0);d([l()],u.prototype,"direction",void 0);d([l({type:Array})],u.prototype,"images",void 0);d([l({type:Array})],u.prototype,"price",void 0);d([l({type:Array})],u.prototype,"amount",void 0);d([l({type:Array})],u.prototype,"symbol",void 0);u=d([R("wui-transaction-list-item")],u);const G=D`
  :host {
    min-height: 100%;
  }
...
`;var w=function(r,t,i,o){var s=arguments.length,e=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,i):o,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(r,t,i,o);else for(var c=r.length-1;c>=0;c--)(n=r[c])&&(e=(s<3?n(e):s>3?n(t,i,e):n(t,i))||e);return s>3&&e&&Object.defineProperty(t,i,e),e};const $="last-transaction",M=7;let f=class extends O{constructor(){super(),this.unsubscribe=[],this.paginationObserver=void 0,this.page="activity",this.caipAddress=v.state.activeCaipAddress,this.transactionsByYear=p.state.transactionsByYear,this.loading=p.state.loading,this.empty=p.state.empty,this.next=p.state.next,p.clearCursor(),this.unsubscribe.push(v.subscribeKey("activeCaipAddress",t=>{t&&this.caipAddress!==t&&(p.resetTransactions(),p.fetchTransactions(t)),this.caipAddress=t}),v.subscribeKey("activeCaipNetwork",()=>{this.updateTransactionView()}),p.subscribe(t=>{this.transactionsByYear=t.transactionsByYear,this.loading=t.loading,this.empty=t.empty,this.next=t.next}))}firstUpdated(){this.updateTransactionView(),this.createPaginationObserver()}updated(){this.setPaginationObserver()}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return a` ${this.empty?null:this.templateTransactionsByYear()}
    ...
    ${!this.loading&&this.empty?this.templateEmpty():null}`}updateTransactionView(){p.resetTransactions(),this.caipAddress&&p.fetchTransactions(I.getPlainAddress(this.caipAddress))}templateTransactionsByYear(){return Object.keys(this.transactionsByYear).sort().reverse().map(i=>{const o=parseInt(i,10),s=new Array(12).fill(null).map((e,n)=>{const c=b.getTransactionGroupTitle(o,n),h=this.transactionsByYear[o]?.[n];return{groupTitle:c,transactions:h}}).filter(({transactions:e})=>e).reverse();return s.map(({groupTitle:e,transactions:n},c)=>{const h=c===s.length-1;return n?a`
        ...
        `:null})})}templateRenderTransaction(t,i){const{date:o,descriptions:s,direction:e,isAllNFT:n,images:c,status:h,transfers:y,type:C}=this.getTransactionListItemProps(t),j=y?.length>1;return y?.length===2&&!n?a`
        <wui-transaction-list-item
          ...
          .descriptions=${s}
        ></wui-transaction-list-item>
      `:j?y.map((_,N)=>{const k=b.getTransferDescription(_),B=i&&N===y.length-1;return a` <wui-transaction-list-item
          date=${o}
    ...
    </wui-flex>`}templateEmpty(){return this.page==="account"?a`${this.emptyStateAccount()}`:a`${this.emptyStateActivity()}`}templateLoading(){return this.page==="activity"?Array(M).fill(a` <wui-transaction-list-item-loader></wui-transaction-list-item-loader> `).map(t=>t):null}onReceiveClick(){Y.push("WalletReceive")}createPaginationObserver(){const t=v.state.activeChain,{projectId:i}=L.state;this.paginationObserver=new IntersectionObserver(([o])=>{o?.isIntersecting&&!this.loading&&(p.fetchTransactions(I.getPlainAddress(this.caipAddress)),z.sendEvent({type:"track",event:"LOAD_MORE_TRANSACTIONS",properties:{address:I.getPlainAddress(this.caipAddress),projectId:i,cursor:this.next,isSmartAccount:E(t)===W.ACCOUNT_TYPES.SMART_ACCOUNT}}))},{}),this.setPaginationObserver()}setPaginationObserver(){this.paginationObserver?.disconnect();const t=this.shadowRoot?.querySelector(`#${$}`);t&&this.paginationObserver?.observe(t)}getTransactionListItemProps(t){const i=F.formatDate(t?.metadata?.minedAt),o=b.getTransactionDescriptions(t),s=t?.transfers,e=t?.transfers?.[0],n=!!e&&t?.transfers?.every(h=>!!h.nft_info),c=b.getTransactionImages(s);return{date:i,direction:e?.direction,descriptions:o,isAllNFT:n,images:c,status:t.metadata?.status,transfers:s,type:t.metadata?.operationType}}};f.styles=G;w([l()],f.prototype,"page",void 0);w([x()],f.prototype,"caipAddress",void 0);w([x()],f.prototype,"transactionsByYear",void 0);w([x()],f.prototype,"loading",void 0);w([x()],f.prototype,"empty",void 0);w([x()],f.prototype,"next",void 0);f=w([R("w3m-activity-list")],f);
