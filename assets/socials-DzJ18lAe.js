import{i as k,a as _,C as $,O as u,R as w,b as U,x as l,d as P,n as A,o as F,A as d,l as E,e as y,p as D,f as p,q as W,S as b,s as N,M as I,T as S}from"./index-D0Nsga9L.js";import{n as j,r as c,c as O,o as C}from"./if-defined-8U-vdW-A.js";import{O as R}from"./index-NRyrmRnW.js";import{e as q}from"./index-DzZzL6r4.js";import"./index-CfCzRn12.js";import"./index-Bsl9TG2a.js";import"./index-BgGfObRE.js";import"./index-BK0Pr3uV.js";import"./index-hoHPrG6f.js";import"./index-DIYLhsVa.js";import"./index-C2Vyi6cn.js";import"./ref-CsYnbbf5.js";import"./ConstantsUtil-Dmg8YACJ.js";import"./index-CtTbUAgI.js";import"./index-D0CyGr97.js";import"./browser-D8_UQ39a.js";const M=k`
  :host {
...
`;var v=function(n,e,t,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,o);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(i=(r<3?s(i):r>3?s(e,t,i):s(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i};let m=class extends _{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=$.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=u.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push($.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(t=>t.type==="AUTH")}),u.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[];const t=!!this.authConnector,o=e?.length,r=w.state.view==="ConnectSocials";return(!t||!o)&&!r?null:(r&&!o&&(e=U.DEFAULT_SOCIALS),l` <wui-flex flexDirection="column" gap="xs">
      ${e.map(i=>l`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await q(e)}async handlePwaFrameLoad(){if(P.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof A&&await this.authConnector.provider.init()}catch(e){F.open({shortMessage:"Error loading embedded wallet in PWA",longMessage:e.message},"error")}finally{this.isPwaLoading=!1}}}};m.styles=M;v([j()],m.prototype,"tabIdx",void 0);v([c()],m.prototype,"connectors",void 0);v([c()],m.prototype,"authConnector",void 0);v([c()],m.prototype,"remoteFeatures",void 0);v([c()],m.prototype,"isPwaLoading",void 0);m=v([O("w3m-social-login-list")],m);const z=k`
  wui-flex {
